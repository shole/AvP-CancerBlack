...
#define MPLAYER_SUPPORT 0 //1

/* Enable in gamecmds.cpp if you want cheats. */
...
char MP_SessionName[MAX_MULTIPLAYER_NAME_LENGTH+23] = "CB GAME";
...
static AVPMENU_ELEMENT AvPMenu_SinglePlayer[] =
{
	...
	{AVPMENU_ELEMENT_GOTOMENU,	 	TEXTSTRING_MENU_BACK,	AVPMENU_MAIN},
	{AVPMENU_ELEMENT_ENDOFMENU}
};
...
static AVPMENU_ELEMENT AvPMenu_Multiplayer[]=
{
	...
	{AVPMENU_ELEMENT_GOTOMENU,	TEXTSTRING_MENU_BACK,	AVPMENU_MULTIPLAYER_CONNECTION},
...
static AVPMENU_ELEMENT AvPMenu_MultiplayerJoinGame[]=
{
	...
	{AVPMENU_ELEMENT_GOTOMENU,	 	TEXTSTRING_MENU_BACK,	AVPMENU_MULTIPLAYER},
...
static AVPMENU_ELEMENT AvPMenu_MultiplayerOpenAddress[]=
{
	...
	{AVPMENU_ELEMENT_GOTOMENU,	 	TEXTSTRING_MENU_BACK,	AVPMENU_MULTIPLAYERJOINGAME},

	{AVPMENU_ELEMENT_ENDOFMENU}

};

// I am removing some stuff here... -- Eldritch
...
//	{AVPMENU_ELEMENT_NUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_PULSERIFLE,	0,	&netGameData.maxMarinePulseRifle,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_NUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_SMARTGUN,		0,	&netGameData.maxMarineSmartgun,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_NUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_FLAMER,		0,	&netGameData.maxMarineFlamer,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_NUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_SADAR,			0,	&netGameData.maxMarineSadar,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_NUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_GRENADE,		0,	&netGameData.maxMarineGrenade,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_NUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_MINIGUN,		0,	&netGameData.maxMarineMinigun,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_NUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_SKEETER,		0,	&netGameData.maxMarineSmartDisc,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_NUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_PISTOLS,		0,	&netGameData.maxMarinePistols,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
...
//	{AVPMENU_ELEMENT_NUMBERFIELD,	TEXTSTRING_MULTIPLAYER_AI_PRAETORIANVALUE,	255,	&netGameData.aiKillValues[2],	TEXTSTRING_MULTIPLAYER_POINTS,	TEXTSTRING_MPHELP_AIVALUE,	TEXTSTRING_BLANK},
	...
	{AVPMENU_ELEMENT_NUMBERFIELD,   TEXTSTRING_MULTIPLAYER_MINIMUM_PLAYERS, 8, &netGameData.MinimumPlayers, TEXTSTRING_BLANK, TEXTSTRING_MPHELP_MINIMUM_PLAYERS, TEXTSTRING_BLANK},
	{AVPMENU_ELEMENT_NUMBERFIELD,	TEXTSTRING_MULTIPLAYER_LIVES,	5,	&netGameData.maxLives,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_LIVES,	TEXTSTRING_MULTIPLAYER_INFINITE},
...
//	{AVPMENU_ELEMENT_TEXTSLIDER,	TEXTSTRING_MULTIPLAYER_SPECIALISTPISTOLS,	1,	&netGameData.specialistPistols,	TEXTSTRING_NO,	TEXTSTRING_MPHELP_SPECIALISTPISTOLS},
	...
	{AVPMENU_ELEMENT_TEXTSLIDER,	TEXTSTRING_MULTIPLAYER_INSTANTSTART, 1, &netGameData.InstantSpawn, TEXTSTRING_NO, TEXTSTRING_MPHELP_INSTANTSTART},
	/* Alien Lifecycle -- Eld */
	{AVPMENU_ELEMENT_TEXTSLIDER,	TEXTSTRING_MULTIPLAYER_LIFECYCLE,	1,	&netGameData.LifeCycle,	TEXTSTRING_NO,	TEXTSTRING_MPHELP_LIFECYCLE},

	{AVPMENU_ELEMENT_ENDOFMENU}
};

// Change this too.. -- Eldritch
...
//	{AVPMENU_ELEMENT_DUMMYNUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_PULSERIFLE,	0,	&netGameData.maxMarinePulseRifle,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_DUMMYNUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_SMARTGUN,		0,	&netGameData.maxMarineSmartgun,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_DUMMYNUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_FLAMER,		0,	&netGameData.maxMarineFlamer,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_DUMMYNUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_SADAR,			0,	&netGameData.maxMarineSadar,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_DUMMYNUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_GRENADE,		0,	&netGameData.maxMarineGrenade,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_DUMMYNUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_MINIGUN,		0,	&netGameData.maxMarineMinigun,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_DUMMYNUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_SKEETER,		0,	&netGameData.maxMarineSmartDisc,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
//	{AVPMENU_ELEMENT_DUMMYNUMBERFIELD,	TEXTSTRING_MULTIPLAYER_MAXMARINE_PISTOLS,		0,	&netGameData.maxMarinePistols,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_MAXSPECIALIST,	TEXTSTRING_BLANK},
...
//	{AVPMENU_ELEMENT_DUMMYNUMBERFIELD,	TEXTSTRING_MULTIPLAYER_AI_PRAETORIANVALUE,	255,	&netGameData.aiKillValues[2],	TEXTSTRING_MULTIPLAYER_POINTS,	TEXTSTRING_MPHELP_AIVALUE,	TEXTSTRING_BLANK},
	{AVPMENU_ELEMENT_DUMMYNUMBERFIELD,  TEXTSTRING_MULTIPLAYER_MINIMUM_PLAYERS, 8, &netGameData.MinimumPlayers, TEXTSTRING_BLANK, TEXTSTRING_MPHELP_MINIMUM_PLAYERS, TEXTSTRING_BLANK},
	{AVPMENU_ELEMENT_DUMMYNUMBERFIELD,	TEXTSTRING_MULTIPLAYER_LIVES,	5,	&netGameData.maxLives,	TEXTSTRING_BLANK,	TEXTSTRING_MPHELP_LIVES,	TEXTSTRING_MULTIPLAYER_INFINITE},
...
//	{AVPMENU_ELEMENT_DUMMYTEXTSLIDER,	TEXTSTRING_MULTIPLAYER_SPECIALISTPISTOLS,	1,	&netGameData.specialistPistols,	TEXTSTRING_NO,	TEXTSTRING_MPHELP_SPECIALISTPISTOLS},
	{AVPMENU_ELEMENT_DUMMYTEXTSLIDER,	TEXTSTRING_MULTIPLAYER_INSTANTSTART, 1, &netGameData.InstantSpawn, TEXTSTRING_NO, TEXTSTRING_MPHELP_INSTANTSTART},
	{AVPMENU_ELEMENT_DUMMYTEXTSLIDER,	TEXTSTRING_MULTIPLAYER_LIFECYCLE,	1,	&netGameData.LifeCycle,	TEXTSTRING_NO,	TEXTSTRING_MPHELP_LIFECYCLE},

	{AVPMENU_ELEMENT_ENDOFMENU}
};

// And here too.. -- Eldritch
...
static AVPMENU_ELEMENT AvPMenu_Multiplayer_Species_Host[]=
{
	...
	{AVPMENU_ELEMENT_GOTOMENU,	 	TEXTSTRING_MENU_BACK,	AVPMENU_MULTIPLAYER_CONFIG},
...
static AVPMENU_ELEMENT AvPMenu_Multiplayer_Species_Join[]=
{
	...
	{AVPMENU_ELEMENT_GOTOMENU,	 	TEXTSTRING_MENU_BACK,	AVPMENU_MULTIPLAYER_CONFIG_JOIN},
...
static AVPMENU_ELEMENT AvPMenu_KeyConfig[NUMBER_OF_PREDATOR_INPUTS+2+1+4];
#else
...
static AVPMENU_ELEMENT AvPMenu_DifficultyLevelSelect[] =
{
	...
	{AVPMENU_ELEMENT_GOTOMENU,	 	TEXTSTRING_MENU_BACK,	AVPMENU_SINGLEPLAYER},
	{AVPMENU_ELEMENT_ENDOFMENU}
};
...
static AVPMENU_ELEMENT AvPMenu_DetailLevels[] =
{
	...
	// New Stuff -- Eld
	{AVPMENU_ELEMENT_TEXTSLIDER,	TEXTSTRING_DETAILLEVELS_WEATHERCOMPLEXITY,		1,	&MenuDetailLevelOptions.WeatherFX,				TEXTSTRING_DETAILLEVELS_OFF,		TEXTSTRING_DETAILLEVELS_WEATHERCOMPLEXITY_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	TEXTSTRING_DETAILLEVELS_MUZZLESMOKE,			1,	&MenuDetailLevelOptions.MuzzleSmoke,			TEXTSTRING_DETAILLEVELS_OFF,		TEXTSTRING_DETAILLEVELS_MUZZLESMOKE_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	TEXTSTRING_DETAILLEVELS_SHELLS,					1,	&MenuDetailLevelOptions.Shells,					TEXTSTRING_DETAILLEVELS_OFF,		TEXTSTRING_DETAILLEVELS_SHELLS_HELP},
	{AVPMENU_ELEMENT_TEXTSLIDER,	TEXTSTRING_DETAILLEVELS_CENTEREDWEAPONS,		1,	&MenuDetailLevelOptions.CenteredWeapons,		TEXTSTRING_DETAILLEVELS_OFF,		TEXTSTRING_DETAILLEVELS_CENTEREDWEAPONS_HELP},
...
extern void MakeInGameMenu(void)
{
	...
	switch (AvP.PlayerType)
	{
		case I_Marine:
		{
			...
			AvPMenu_InNetGame[4].TextDescription = TEXTSTRING_MARINEKEYCONTROLS_TITLE;
			AvPMenu_InNetGame[4].MenuToGoTo = AVPMENU_MARINEKEYCONFIG;
			break;
		}
		case I_Predator:
		{
			...
			AvPMenu_InNetGame[4].TextDescription = TEXTSTRING_PREDATORKEYCONTROLS_TITLE;
			AvPMenu_InNetGame[4].MenuToGoTo = AVPMENU_PREDATORKEYCONFIG;
			break;
		}
		case I_Alien:
		{
			...
			AvPMenu_InNetGame[4].TextDescription = TEXTSTRING_ALIENKEYCONTROLS_TITLE;
			AvPMenu_InNetGame[4].MenuToGoTo = AVPMENU_ALIENKEYCONFIG;
			break;
		}
	}
}
...
extern void MakePredatorKeyConfigMenu(void)
{
	...
	#if EXTENDED_CONTROLS
	AvPMenu_KeyConfig[i+j].ElementID = AVPMENU_ELEMENT_KEYCONFIG;
	AvPMenu_KeyConfig[i+j].TextDescription = TEXTSTRING_KEY_CHANGESPECIES;
	AvPMenu_KeyConfig[i+j].MenuToGoTo = AVPMENU_MAIN;
	AvPMenu_KeyConfig[i+j].HelpString = TEXTSTRING_KEYCONTROLS_HELP;

	AvPMenu_KeyConfig[i+j+1].ElementID = AVPMENU_ELEMENT_KEYCONFIG;
	AvPMenu_KeyConfig[i+j+1].TextDescription = TEXTSTRING_KEY_CHANGECLASS;
	...
	AvPMenu_KeyConfig[i+j+2].ElementID = AVPMENU_ELEMENT_TEXTSLIDER;
	AvPMenu_KeyConfig[i+j+2].TextDescription = TEXTSTRING_RUNMODE;
	AvPMenu_KeyConfig[i+j+2].MaxSliderValue = 1;
	AvPMenu_KeyConfig[i+j+2].SliderValuePtr = &RunMode_Temp;
	AvPMenu_KeyConfig[i+j+2].FirstTextSliderString = TEXTSTRING_TOGGLE;
	AvPMenu_KeyConfig[i+j+2].HelpString = TEXTSTRING_RUNMODE_HELP;

	AvPMenu_KeyConfig[i+j+3].ElementID = AVPMENU_ELEMENT_ENDOFMENU;
	#else
...
extern void MakeMarineKeyConfigMenu(void)
{
	...
	#if EXTENDED_CONTROLS
	AvPMenu_KeyConfig[i+j].ElementID = AVPMENU_ELEMENT_KEYCONFIG;
	AvPMenu_KeyConfig[i+j].TextDescription = TEXTSTRING_MARINE_GRENADE;
	AvPMenu_KeyConfig[i+j].MenuToGoTo = AVPMENU_MAIN;
	AvPMenu_KeyConfig[i+j].HelpString = TEXTSTRING_KEYCONTROLS_HELP;

	AvPMenu_KeyConfig[i+j+1].ElementID = AVPMENU_ELEMENT_KEYCONFIG;
	AvPMenu_KeyConfig[i+j+1].TextDescription = TEXTSTRING_MARINE_MEDIKIT;
	AvPMenu_KeyConfig[i+j+1].MenuToGoTo = AVPMENU_MAIN;
	AvPMenu_KeyConfig[i+j+1].HelpString = TEXTSTRING_KEYCONTROLS_HELP;

	AvPMenu_KeyConfig[i+j+2].ElementID = AVPMENU_ELEMENT_KEYCONFIG;
	AvPMenu_KeyConfig[i+j+2].TextDescription = TEXTSTRING_MARINE_SENTRYGUN;
	AvPMenu_KeyConfig[i+j+2].MenuToGoTo = AVPMENU_MAIN;
	AvPMenu_KeyConfig[i+j+2].HelpString = TEXTSTRING_KEYCONTROLS_HELP;

	AvPMenu_KeyConfig[i+j+3].ElementID = AVPMENU_ELEMENT_KEYCONFIG;
	AvPMenu_KeyConfig[i+j+3].TextDescription = TEXTSTRING_KEY_CHANGESPECIES;
	AvPMenu_KeyConfig[i+j+3].MenuToGoTo = AVPMENU_MAIN;
	AvPMenu_KeyConfig[i+j+3].HelpString = TEXTSTRING_KEYCONTROLS_HELP;

	AvPMenu_KeyConfig[i+j+4].ElementID = AVPMENU_ELEMENT_KEYCONFIG;
	AvPMenu_KeyConfig[i+j+4].TextDescription = TEXTSTRING_KEY_CHANGECLASS;
	AvPMenu_KeyConfig[i+j+4].MenuToGoTo = AVPMENU_MAIN;
	AvPMenu_KeyConfig[i+j+4].HelpString = TEXTSTRING_KEYCONTROLS_HELP;
	#endif
	...
	AvPMenu_KeyConfig[i+j+5].ElementID = AVPMENU_ELEMENT_TEXTSLIDER;
	AvPMenu_KeyConfig[i+j+5].TextDescription = TEXTSTRING_AUTOWEAPONCHANGE;	
	AvPMenu_KeyConfig[i+j+5].MaxSliderValue = 1;	
	AvPMenu_KeyConfig[i+j+5].SliderValuePtr = &AutoWeaponChangeOn_Temp;	
	AvPMenu_KeyConfig[i+j+5].FirstTextSliderString = TEXTSTRING_NO;	
	AvPMenu_KeyConfig[i+j+5].HelpString = TEXTSTRING_AUTOWEAPONCHANGE_HELP;

	#if EXTENDED_CONTROLS
	
	RunMode_Temp = RunMode;

	AvPMenu_KeyConfig[i+j+6].ElementID = AVPMENU_ELEMENT_TEXTSLIDER;
	AvPMenu_KeyConfig[i+j+6].TextDescription = TEXTSTRING_RUNMODE;
	AvPMenu_KeyConfig[i+j+6].MaxSliderValue = 1;
	AvPMenu_KeyConfig[i+j+6].SliderValuePtr = &RunMode_Temp;
	AvPMenu_KeyConfig[i+j+6].FirstTextSliderString = TEXTSTRING_TOGGLE;
	AvPMenu_KeyConfig[i+j+6].HelpString = TEXTSTRING_RUNMODE_HELP;

	AvPMenu_KeyConfig[i+j+7].ElementID = AVPMENU_ELEMENT_ENDOFMENU;
	#else
...
extern void MakeAlienKeyConfigMenu(void)
{
	...
	CrouchMode_Temp = CrouchIsToggleKey;

	AvPMenu_KeyConfig[i+j+3].ElementID = AVPMENU_ELEMENT_TEXTSLIDER;
	AvPMenu_KeyConfig[i+j+3].TextDescription = TEXTSTRING_CROUCHMODE;
	AvPMenu_KeyConfig[i+j+3].MaxSliderValue = 1;
	AvPMenu_KeyConfig[i+j+3].SliderValuePtr = &CrouchMode_Temp;
	AvPMenu_KeyConfig[i+j+3].FirstTextSliderString = TEXTSTRING_TOGGLE;
	AvPMenu_KeyConfig[i+j+3].HelpString = TEXTSTRING_CROUCHMODE_HELP;

	AvPMenu_KeyConfig[i+j+4].ElementID = AVPMENU_ELEMENT_ENDOFMENU;
	#else
	AvPMenu_KeyConfig[i+j].ElementID = AVPMENU_ELEMENT_ENDOFMENU;
	#endif
}
...
extern void MakeConnectionSelectMenu()
{
	...
	/* Add the launch of serverposter.exe to look for online games. */
	{
		AvPMenu_MultiplayerConnection[pos].ElementID =	AVPMENU_ELEMENT_CONNECTIONCHOICE;
		AvPMenu_MultiplayerConnection[pos].TextDescription = TEXTSTRING_MPLAYER_TEXT_1;
		AvPMenu_MultiplayerConnection[pos].MenuToGoTo = AVPMENU_MULTIPLAYER;
	...
	//if(pos==0)
	{
		//no available connections; Actually, print a back button. -- Eld
		AvPMenu_MultiplayerConnection[pos].ElementID = AVPMENU_ELEMENT_GOTOMENU;
		AvPMenu_MultiplayerConnection[pos].TextDescription = TEXTSTRING_MENU_BACK;
		AvPMenu_MultiplayerConnection[pos].MenuToGoTo = AVPMENU_MAIN;
